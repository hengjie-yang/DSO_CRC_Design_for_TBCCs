...
%   Unlike the collecting procedure in ISIT 2020 paper, this algorithm
%   collects IEE that start and end at state \sigma and never traverse in
%   between.
%   
%   Inputs:
...
%
%
%   Written by Hengjie Yang(hengjie.yang@ucla.edu)  04/19/21
%
...
save(['Trivial_IEEs_TBCC_',code_string,'d_',num2str(d_tilde),'.mat'],...
    'IEE','-v7.3');
